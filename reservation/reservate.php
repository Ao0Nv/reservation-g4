...
<body>
    ...
    <?php
        ...
        if(isset($_POST["ok"]))
        {
            ...
            $sql = 'INSERT INTO reservation(code, date, start, finish, registrant, num_of_poeple, purpose) VALUES('.$code.', '.$date_inp.', '.$start_inp.', '. $finish_inp.', '. $redistrant_inp.' ,'. $num_of_people_inp.', '$purpose_inp')';
